...
#define HOMING_BUMP_DIVISOR { 20, 20, 50 }  // Re-Bump Speed Divisor (Divides the Homing Feedrate)
...
#define BUFSIZE 8 // @advi3++ ADVi3++ needs more than just 4 commands
...
#define ADVANCED_PAUSE_FEATURE
  ...
  #define ADVANCED_PAUSE_PURGE_LENGTH         30  // (mm) Length to extrude after loading. // @advi3++: purge less
 ...
 */
// @advi3++: In case of a major problem, send the poweroff action to the host
